  ...
  namespace util
  {
                  ...
                  )
    {
      ...
      for (std::size_t i = 0; i < num_vertices; ++i)
      {
        ...
        VIENNASHE_VIENNAGRID_CHECK(viennagrid_mesh_vertex_coords_get(device.mesh(), vertices_begin[i], &coords));
      ...
      for (std::size_t i = 0; i < num_cells; ++i)
      {
        ...
        VIENNASHE_VIENNAGRID_CHECK(viennagrid_element_boundary_elements(device.mesh(), cells_begin[i], 0, &vertices_on_cell_begin, &vertices_on_cell_end));
